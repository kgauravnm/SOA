 ...
 * 
 */
@WebServiceClient(name = "CarService", targetNamespace = "http://carservice.example.com/", wsdlLocation = "http://localhost:9001/car?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CARSERVICE_QNAME = new QName("http://carservice.example.com/", "CarService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9001/car?wsdl");
     ...
     *     returns CarService
     */
    @WebEndpoint(name = "CarServiceEndpoint")
    public CarService getCarServiceEndpoint() {
        return super.getPort(new QName("http://carservice.example.com/", "CarServiceEndpoint"), CarService.class);
    }
     ...
     */
    @WebEndpoint(name = "CarServiceEndpoint")
    public CarService getCarServiceEndpoint(WebServiceFeature... features) {
        return super.getPort(new QName("http://carservice.example.com/", "CarServiceEndpoint"), CarService.class, features);
    }
